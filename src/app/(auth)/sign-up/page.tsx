...
function page() {
  ...
  //zod implementation
  const form = useForm<z.infer<typeof signUpSchema>>({           //form object containing register, handleSubmit, control, etc.
  ...
  const onSubmit = async (data: z.infer<typeof signUpSchema>) => {
    ...
    try {
      ...
      toast("User created successfully! Now verify",
        {
          description: "First verify your account."
        });
      // With options:
      // toast("User created!", {
